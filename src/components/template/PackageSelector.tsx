      ...
      <div className="flex items-center justify-between gap-1.5 p-1.5 bg-white border border-slate-200/90 rounded-2xl shadow-xs">
        ...
        <div className="relative flex-1 min-w-0">
          <button
            ...
            className="w-full flex items-center justify-between gap-1.5 px-2.5 py-1.5 bg-slate-50/90 hover:bg-slate-100/90 text-left border border-slate-200/90 rounded-xl transition-all group shadow-2xs overflow-hidden"
          >
            <div className="flex items-center gap-1.5 min-w-0 flex-1">
              <div className="w-5 h-5 rounded-lg bg-emerald-100 text-emerald-700 flex items-center justify-center flex-shrink-0 font-bold shadow-2xs">
              ...
              {activeLinkedTask && (
                <span
                  ...
                  className="inline-flex items-center gap-0.5 px-1.5 py-0.2 rounded bg-emerald-100/80 hover:bg-emerald-200 text-emerald-900 text-[10px] font-bold border border-emerald-300/80 transition-colors flex-shrink-0 shadow-2xs cursor-pointer whitespace-nowrap"
                >
