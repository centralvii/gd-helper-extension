      ...
      <div className="flex items-center justify-between gap-1.5 p-1.5 bg-white border border-slate-200/90 rounded-2xl shadow-xs">
        ...
        <div className="relative flex-1 min-w-0">
          <button
            ...
            className="w-full flex items-center justify-between gap-2 px-3 py-2 bg-slate-50/90 hover:bg-slate-100/90 text-left border border-slate-200/90 rounded-xl transition-all group shadow-2xs"
          >
              ...
              <div className="flex items-center gap-1.5 min-w-0">
                ...
                {activeLinkedTask && (
                  <span
                    ...
                    className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-emerald-100/80 hover:bg-emerald-200 text-emerald-900 text-[10px] font-bold border border-emerald-300/80 transition-colors flex-shrink-0 shadow-2xs cursor-pointer"
                  >
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              <span className="px-2 py-0.5 rounded-lg bg-white border border-slate-200 text-[10.5px] font-bold text-slate-600 shadow-2xs">
        ...
        <div className="flex items-center gap-0.5 flex-shrink-0">
          ...
          {onOpenReadme && (
            <button
              ...
              className="icon-btn relative p-1.5 text-gray-500 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition-colors"
            >
